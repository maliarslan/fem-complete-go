...
// this is right now A full patch update where all existing workout entries are deleted
// and then reinserted with the new data, instead of updating individual entries
